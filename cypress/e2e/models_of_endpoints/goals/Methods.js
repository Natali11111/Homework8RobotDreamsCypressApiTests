...
export const createGoal = (goalName) => {
    return cy.sendRequest('team/90151222161/goal', 'POST', {name: goalName});
}
...
export const createGoalWithMissingToken = (goalName, token) => {
    return cy.sendRequestWithoutAuthorization('team/90151222161/goal', 'POST', {name: goalName}, token);
}
...
export const getGoals = () => {
    return cy.sendRequest('team/90151222161/goal', 'GET');
}
...
export const getGoalsWithoutAuthorization = (token) => {
    return cy.sendRequestWithoutAuthorization('team/90151222161/goal', 'GET', token);
}
